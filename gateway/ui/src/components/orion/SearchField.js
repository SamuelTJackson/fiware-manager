...
const SearchField = ({idPattern,
                       setIdPattern, setFiwareService, setFiwareServicePath, search, fiwareService, fiwareServicePath}) => {
  ...
  return (
    <Paper variant="outlined" className={classes.root}>
      ...
      <InputBase
        ...
        inputProps={{ 'aria-label': 'naked' }}
        onChange={(event) => setIdPattern(event.target.value)}
      />
      <Divider className={classes.divider} orientation="vertical"/>
